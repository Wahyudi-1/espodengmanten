...
function tampilkanStruk(dataTransaksi, idTransaksi) {
    let htmlStruk = `<h3>Toko Anda</h3><p>ID Transaksi: ${idTransaksi}</p><p>Waktu: ${new Date().toLocaleString('id-ID')}</p><p>Kasir: ${dataTransaksi.kasir}</p><hr>`;
    ...
    htmlStruk += `<hr><p style="text-align:center; margin-top:10px;">Terima Kasih!</p>`;
